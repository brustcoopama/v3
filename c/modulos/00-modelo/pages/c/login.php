 ...
 */
class LoginControllerPage extends \moduloControllers\Page
{
    ...
    public function loadParams()
    {
        ...
        $params['security'] = [
            ...
            'loginPage'         => '/' . $this->params['paths']['DIR_BASE'] . $this->params['paths']['M_NAME'] . '/login/',

            // Caminho para página restrita.
            'restrictPage'      => '/' . $this->params['paths']['DIR_BASE'] . $this->params['paths']['M_NAME'] . '/admin/',
